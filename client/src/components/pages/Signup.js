...
const Signup = ({ setProgress }) => {
  ...
  const SignUp = async (formData) => {
    try {
    const URL = 'https://gemlifestylesserver.gemlifestyles.com/api/auth/signup';
  ...
  return (
    <div className='Signup text-center container'>
      ...
      <form className='my-4' encType="multipart/form-data" method="POST" onSubmit={handleSubmit}>
        <input type="text" className="form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" onChange={onChange} name="fname" value={credentials.fname} id="fname" placeholder='FirstName' minLength={3} autoComplete="true" required />
        ...
        <input type="email" className="form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" onChange={onChange} name="email" value={credentials.email} id="email" aria-describedby="emailHelp" placeholder='Email' autoComplete="true" required />
        <input type="number" className="form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" onChange={onChange} name="phone" value={credentials.phone} id="phone" placeholder='Phone Number' autoComplete="true" />
        <input type="text" className="form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" onChange={onChange} name="address" value={credentials.address} id="address" placeholder='Address' autoComplete="true" />

        <select id="city" className="form-select form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" name='city' value={credentials.city} onChange={onChange} >
        ...
        <select id="state" className="form-select form-control outline-none shadow-none rounded-0 mb-3 py-2 px-3" name='state' value={credentials.state} onChange={onChange} >
          <option defaultValue="" disabled>Please select a region, state or province.</option>
